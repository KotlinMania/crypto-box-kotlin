// port-lint: tests crypto_box/tests/lib.rs
...
class CryptoBoxTest {
    ...
    private val salsaCiphertext = hexToBytes(
    ...
    private val chachaCiphertext = hexToBytes(
    ...
    private val sealCiphertext = hexToBytes(
