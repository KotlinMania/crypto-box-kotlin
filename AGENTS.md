...
This file is the quick-reference operating contract for crypto-box-kotlin. The longer
...
crypto-box-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`crypto_box`](https://crates.io/crates/crypto_box). Upstream Rust is the behavioral oracle while the
