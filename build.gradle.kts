...
kotlin {
    ...
    swiftExport {
        moduleName = "CryptoBox"
        flattenPackage = "io.github.kotlinmania.cryptobox"
    }

    android {
        namespace = "io.github.kotlinmania.cryptobox"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "crypto-box-kotlin", version.toString())
